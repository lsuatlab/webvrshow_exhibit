...
## Description
Maratropa is an extensive data vis/data art project, visualizing any Twitter account as an abstract city. The structure in the middle, with shape and size dependent on the growth of each following, symbolises religious like objectification, while all everything around is based on their actual ‘followers’.   
